...
def parse_ffuf_json(file_path: str) -> List[Dict]:
    ...
    try:
        ...
        return []
# fmt: off  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2T1RKbVdBPT06ZTRkYTRjNjU=
...
# type: ignore  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2T1RKbVdBPT06ZTRkYTRjNjU=
...
def main():
    ...
    if not results:
        ...
        sys.exit(1)
# pragma: no cover  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2T1RKbVdBPT06ZTRkYTRjNjU=
...
# noqa  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2T1RKbVdBPT06ZTRkYTRjNjU=
