...
# type: ignore  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2WmpWM1JnPT06MzgyYzg5NWQ=
...
def detect_from_cookies(headers: Dict[str, str]) -> List[str]:
    ...
    return list(set(detected))
# pylint: disable  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2WmpWM1JnPT06MzgyYzg5NWQ=
    ...
    try:
        ...
        for pattern in CHALLENGE_PATTERNS:
            if pattern in content_lower:
                ...
                break
# pylint: disable  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2WmpWM1JnPT06MzgyYzg5NWQ=
...
# fmt: off  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2WmpWM1JnPT06MzgyYzg5NWQ=
