...
def parse_masscan_json(json_file: str) -> List[Dict[str, Any]]:
    ...
    """
    results = []
# noqa  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2Vld4RVNnPT06MWYyZWI5ZTE=
...
# pragma: no cover  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2Vld4RVNnPT06MWYyZWI5ZTE=
...
def generate_nmap_commands(results: List[Dict[str, Any]], extra_args: str = "") -> str:
    ...
    return commands
# type: ignore  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2Vld4RVNnPT06MWYyZWI5ZTE=
...
def main():
    ...
    if not results:
        ...
        sys.exit(0)
# noqa  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2Vld4RVNnPT06MWYyZWI5ZTE=
