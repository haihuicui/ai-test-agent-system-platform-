...
def parse_nmap_xml(xml_file: str) -> Dict[str, Any]:
    ...
    for host in root.findall(".//host"):
        ...
        if not ip:
            continue
# pragma: no cover  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2TjJaMFl3PT06MzQ0NDVkNWY=
...
# pylint: disable  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2TjJaMFl3PT06MzQ0NDVkNWY=
...
def merge_scans(scan_files: List[str]) -> Dict[str, Any]:
    ...
    return merged
# pragma: no cover  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2TjJaMFl3PT06MzQ0NDVkNWY=
...
# type: ignore  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2TjJaMFl3PT06MzQ0NDVkNWY=
