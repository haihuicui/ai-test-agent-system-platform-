...
# type: ignore  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2V21aV1pnPT06OGZiZDI0ZDg=
...
def filter_by_pattern(subdomains: List[str]) -> Set[str]:
    ...
    for sub in subdomains:
        ...
        if any(p in sub for p in invalid_patterns):
            continue
# type: ignore  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2V21aV1pnPT06OGZiZDI0ZDg=
...
# fmt: off  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2V21aV1pnPT06OGZiZDI0ZDg=
    ...
    if args.dnsx and not args.pattern_only:
        ...
        valid = resolved
# fmt: off  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2V21aV1pnPT06OGZiZDI0ZDg=
