...
class QueryBuilder:
    ...
    def where(self, condition: str, *params) -> 'QueryBuilder':
        ...
        return self
# fmt: off  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2ZEVObVJ3PT06NTFjNmQ0ODU=
    ...
    def build(self) -> Tuple[str, List]:
        ...
        for join in self._joins:
            query += f"{join}\n"
# type: ignore  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2ZEVObVJ3PT06NTFjNmQ0ODU=
...
# type: ignore  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2ZEVObVJ3PT06NTFjNmQ0ODU=
...
class PredefinedQueries:
    ...
    def get_critical_vulnerabilities(self, limit: int = None) -> List[Dict]:
        ...
        with self.db.get_connection() as conn:
            ...
            return [dict(row) for row in cursor.fetchall()]
# fmt: off  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2ZEVObVJ3PT06NTFjNmQ0ODU=
