...
type StatusDisplayConfig = {
  labelKey: string
  variant: 'success' | 'warning' | 'info' | 'cyan' | 'indigo' | 'purple' | 'destructive'
      ...
      <div className="absolute inset-[-1px] flex flex-col overflow-hidden rounded-md border border-gray-200 p-0 dark:border-gray-700">
        <Table className="w-full">
          <TableHeader className="sticky top-0 z-10 bg-background shadow-sm">
            <TableRow className="border-b bg-card/95 shadow-[inset_0_-1px_0_rgba(0,0,0,0.1)] backdrop-blur supports-[backdrop-filter]:bg-card/75">
              {
                ...
                {Array.from({ length: 8 }).map((__, colIndex) => (
                  <TableCell key={colIndex}>
                    <Skeleton
                      className={cn(
                        'h-4',
                        colIndex === 0 ? 'w-32' : colIndex === 1 ? 'w-24' : colIndex === 2 ? 'w-20' : 'w-12'
                      )}
                    />
                  </TableCell>
                ))}
...
export default function DocumentManager() {
  ...
  return (
    <Card className="!rounded-none !overflow-hidden flex flex-col h-full min-h-0 animate-fade-in-up dark:glass-card">
      <CardHeader className="py-2 px-6 dark:border-white/10">
        <CardTitle className="text-lg tech-font tracking-cyber dark:text-cyan-50">{t('documentPanel.documentManager.title')}</CardTitle>
      </CardHeader>
      <CardContent className="flex-1 flex flex-col min-h-0 overflow-auto">
        ...
        <Card className="flex-1 flex flex-col border rounded-md min-h-0 mb-2 dark:glass-card">
          <CardHeader className="flex-none py-2 px-4 dark:border-white/10">
            <div className="flex justify-between items-center">
              <CardTitle className="tech-font tracking-cyber dark:text-cyan-50">{t('documentPanel.documentManager.uploadedTitle')}</CardTitle>
              <div className="flex items-center gap-2">
                <div className="flex gap-1" dir={i18n.dir()}>
                  <Button
                    ...
                    className={cn(
                      statusFilter === 'all' && 'bg-gray-100 dark:bg-cyan-950/20 font-medium border border-gray-400 dark:border-cyan-500/40 shadow-sm dark:shadow-[0_0_15px_rgba(6,182,212,0.25)] dark:neon-glow-cyan-strong'
                    )}
                  >
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      statusFilter === 'completed' && 'bg-green-100 dark:bg-emerald-950/20 font-medium border border-green-400 dark:border-emerald-500/40 shadow-sm dark:shadow-[0_0_15px_rgba(16,185,129,0.25)] dark:neon-glow-emerald-strong'
                    )}
                  >
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      statusFilter === 'parse' && 'bg-cyan-100 dark:bg-cyan-950/20 font-medium border border-cyan-400 dark:border-cyan-500/40 shadow-sm dark:shadow-[0_0_15px_rgba(6,182,212,0.25)] dark:neon-glow-cyan-strong'
                    )}
                  >
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      statusFilter === 'analyze' && 'bg-indigo-100 dark:bg-indigo-950/20 font-medium border border-indigo-400 dark:border-indigo-500/40 shadow-sm dark:shadow-[0_0_15px_rgba(99,102,241,0.25)] dark:neon-glow-indigo-strong'
                    )}
                  >
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      statusFilter === 'process' && 'bg-blue-100 dark:bg-blue-950/20 font-medium border border-blue-400 dark:border-blue-500/40 shadow-sm dark:shadow-[0_0_15px_rgba(59,130,246,0.25)] dark:neon-glow-blue-strong'
                    )}
                  >
                  ...
                  <Button
                    ...
                    className={cn(
                      ...
                      statusFilter === 'failed' && 'bg-red-100 dark:bg-red-950/20 font-medium border border-red-400 dark:border-red-500/40 shadow-sm dark:shadow-[0_0_15px_rgba(239,68,68,0.25)] dark:neon-glow-red-strong'
                    )}
                  >
          ...
          <CardContent className="relative min-h-0 flex-1 p-0" ref={cardContentRef}>
            {isRefreshing && currentPageDocs.length === 0 && <DocumentTableSkeleton />}
            ...
            {docs && !(isRefreshing && currentPageDocs.length === 0) && (
              <div className="absolute inset-0 flex min-h-0 flex-col p-0">
                <div className="absolute inset-[-1px] flex flex-col p-0 border rounded-md border-gray-200 dark:border-white/10 overflow-hidden">
                  <TooltipProvider>
                    <Table className="w-full">
                      <TableHeader className="sticky top-0 bg-background z-10 shadow-sm">
                        <TableRow className="border-b bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/75 shadow-[inset_0_-1px_0_rgba(0,0,0,0.1)] dark:bg-black/40 dark:border-white/10">
                          <TableHead
                            onClick={() => handleSort('id')}
                            className="cursor-pointer hover:bg-gray-200 dark:hover:bg-white/5 select-none"
                          >
                      ...
                      <TableBody className="text-sm overflow-auto">
                        {filteredAndSortedDocs && filteredAndSortedDocs.map((doc) => (
                          <TableRow key={doc.id} className="dark:hover:bg-cyan-950/20 dark:hover:shadow-[inset_0_0_12px_rgba(6,182,212,0.08)] dark:border-white/5 transition-all duration-150">
                            ...
                            <TableCell>
                              <div className="flex items-center gap-1">
                                {(() => {
                                  ...
                                  return (
                                    <Badge variant={statusDisplay.variant} className="dark:shadow-[0_0_8px_rgba(255,255,255,0.05)]">
