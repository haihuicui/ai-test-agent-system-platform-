  ...
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      >
        ...
        <div className="bg-background/60 dark:bg-black/30 dark:backdrop-blur-xl absolute bottom-2 left-2 flex flex-col rounded-xl border-2 backdrop-blur-lg dark:border-cyan-500/30 dark:shadow-[0_0_15px_rgba(6,182,212,0.15)]">
          <LayoutsControl />
          <ZoomControl />
          <FullScreenControl />
          <LegendButton />
      ...
      {(isFetching || isThemeSwitching || isLayoutComputing) && (
        <div className="bg-background/80 dark:bg-black/60 dark:backdrop-blur-xl absolute inset-0 z-10 flex items-center justify-center">
          <div className="text-center">
            <div className="border-primary mx-auto mb-3 h-10 w-10 animate-spin rounded-full border-4 border-t-transparent dark:shadow-[0_0_15px_rgba(6,182,212,0.4)]"></div>
            <p className="dark:text-cyan-100 tech-font tracking-cyber">
              {isThemeSwitching
                ? 'Switching Theme...'
                : isFetching
                  ? 'Loading Graph Data...'
            ...
            <div className="mt-3 mx-auto h-1 w-32 rounded-full bg-gradient-to-r from-transparent via-cyan-500/50 to-transparent dark:animate-shimmer"></div>
          </div>
        </div>
      )}
    </div>
