...
export default function RetrievalView() {
  ...
  return (
    <div className="flex size-full gap-2 px-2 pb-12 overflow-hidden animate-fade-in-up">
      <div className="flex grow flex-col gap-4">
        <div className="relative grow">
          <div
            ref={messagesContainerRef}
            className="absolute inset-0 flex flex-col overflow-auto rounded-lg border p-2 bg-primary-foreground/60 dark:bg-black/30 dark:backdrop-blur-xl dark:border-white/10"
        ...
        >
          ...
          <div className="flex-1 relative">
            ...
            {hasMultipleLines ? (
              <Textarea
                ...
                id="query-input"
                autoComplete="on"
                className="w-full min-h-[40px] max-h-[120px] overflow-y-auto dark:bg-black/30 dark:backdrop-blur-xl dark:border-white/10 dark:focus:shadow-[0_0_15px_rgba(6,182,212,0.3)]"
                value={inputValue}
              ...
              <Input
                ...
                id="query-input"
                autoComplete="on"
                className="w-full dark:bg-black/30 dark:backdrop-blur-xl dark:border-white/10 dark:focus:shadow-[0_0_15px_rgba(6,182,212,0.3)]"
                value={inputValue}
                onChange={handleChange}
                onKeyDown={handleKeyDown}
                onPaste={handlePaste}
          ...
          {isLoading ? (
            <Button type="button" variant="destructive" onClick={handleStop} disabled={stopDisabled} size="sm" className="dark:shadow-[0_0_20px_rgba(239,68,68,0.4)] dark:animate-neon-pulse">
              <SquareIcon />
              {t('retrievePanel.retrieval.stop')}
            </Button>
          ) : (
            <Button type="submit" variant="default" size="sm" className="dark:shadow-[0_0_20px_rgba(6,182,212,0.4)] dark:animate-neon-pulse">
              <SendIcon />
