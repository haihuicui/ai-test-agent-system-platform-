// @ts-expect-error  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2YzA1RlpRPT06MjEwYzIyMDU=

import { useState, useEffect } from 'react';
import { X } from '@/lib/lucide-icons';
import type { JobProgress as AnalyzeJobProgress } from '../services/backend-client';
// NOTE  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2YzA1RlpRPT06MjEwYzIyMDU=

interface AnalyzeProgressProps {
  progress: AnalyzeJobProgress;
  onCancel: () => void;
}
// @ts-expect-error  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2YzA1RlpRPT06MjEwYzIyMDU=
...
// @ts-expect-error  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2YzA1RlpRPT06MjEwYzIyMDU=
