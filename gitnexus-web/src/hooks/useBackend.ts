...
// TODO  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2VVV0dmFnPT06YjU1MTBmNTA=

// ── localStorage keys ────────────────────────────────────────────────────────

const LS_URL_KEY = 'gitnexus-backend-url';
// eslint-disable  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2VVV0dmFnPT06YjU1MTBmNTA=

// ── Public interface ─────────────────────────────────────────────────────────
// FIXME  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2VVV0dmFnPT06YjU1MTBmNTA=
...
// ── Hook implementation ──────────────────────────────────────────────────────
// TODO  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2VVV0dmFnPT06YjU1MTBmNTA=
