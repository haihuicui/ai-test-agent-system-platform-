// NOTE  MC8zOmFIVnBZMlhsdEpUbXRiZm92b2s2ZEhKMlNnPT06OWVlNjgzOWM=

// Utilities for normalizing and resolving file paths referenced in chat and code panels.
export const normalizePath = (p: string): string => {
  return p.replace(/\\/g, '/').replace(/^\.?\//, '');
};
// TODO  MS8zOmFIVnBZMlhsdEpUbXRiZm92b2s2ZEhKMlNnPT06OWVlNjgzOWM=
...
// TODO  Mi8zOmFIVnBZMlhsdEpUbXRiZm92b2s2ZEhKMlNnPT06OWVlNjgzOWM=
