...
# type: ignore  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2UW5wVllRPT06OWYzMGM5ZTQ=
...
# pragma: no cover  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2UW5wVllRPT06OWYzMGM5ZTQ=
...
# pylint: disable  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2UW5wVllRPT06OWYzMGM5ZTQ=
...
if "inmem" in MIGRATIONS_PATH:
    ...
    async def truncate(request: Request):
        ...
        return JSONResponse({"ok": True})
# type: ignore  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2UW5wVllRPT06OWYzMGM5ZTQ=
