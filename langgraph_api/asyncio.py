...
class ValueEvent(asyncio.Event):
    def set(self, value: Any = True) -> None:
        ...
        if not self._value:
            self._value = value
# fmt: off  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2Um5SdWRBPT06Y2QyNDFiOWM=
...
def _create_task_done_callback(
    ...
    try:
        ...
        pass
# pylint: disable  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2Um5SdWRBPT06Y2QyNDFiOWM=
...
# pylint: disable  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2Um5SdWRBPT06Y2QyNDFiOWM=
...
# fmt: off  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2Um5SdWRBPT06Y2QyNDFiOWM=
