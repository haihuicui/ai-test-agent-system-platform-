...
# fmt: off  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2T1dsa2FRPT06ZjA2ZGU0NTA=
...
def main():
    import argparse
# pylint: disable  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2T1dsa2FRPT06ZjA2ZGU0NTA=
...
def _check_newer_version(pkg: str, current_version: str, timeout: float = 0.5) -> None:
    ...
    if os.getenv("LANGGRAPH_NO_VERSION_CHECK", "").lower() in ("true", "1"):
        return
# type: ignore  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2T1dsa2FRPT06ZjA2ZGU0NTA=
