...
# pragma: no cover  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2V1VOMmRnPT06Mjc5NWUwMGU=
...
class SerdeConfig(TypedDict, total=False):
    ...
    Defaults to True if not configured."""
# pragma: no cover  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2V1VOMmRnPT06Mjc5NWUwMGU=
...
# pylint: disable  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2V1VOMmRnPT06Mjc5NWUwMGU=
