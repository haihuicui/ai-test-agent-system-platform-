...
# fmt: off  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2WWtkbFZBPT06NDNhZGI1NjQ=
...
async def _generate_graph(value: Any) -> AsyncIterator[Any]:
    ...
    if isinstance(value, Pregel | BaseRemotePregel):
        ...
        yield value
# pragma: no cover  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2WWtkbFZBPT06NDNhZGI1NjQ=
...
# type: ignore  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2WWtkbFZBPT06NDNhZGI1NjQ=
...
# fmt: off  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2WWtkbFZBPT06NDNhZGI1NjQ=
