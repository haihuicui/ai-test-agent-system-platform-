...
# pragma: no cover  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2UWpsUVZRPT06NjJhYTA3MGE=
...
class Assistants(object):
    ...
    def Patch(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            metadata,
            _registered_method=True)
# type: ignore  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2UWpsUVZRPT06NjJhYTA3MGE=
...
class ThreadsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SweepTTL = channel.unary_unary(
                ...
                _registered_method=True)
# noqa  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2UWpsUVZRPT06NjJhYTA3MGE=
...
class ThreadsServicer(object):
    ...
    def Count(self, request, context):
        ...
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
# pylint: disable  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2UWpsUVZRPT06NjJhYTA3MGE=
