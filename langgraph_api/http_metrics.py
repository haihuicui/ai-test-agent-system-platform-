...
# type: ignore  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2ZDJ4cVpnPT06MDg2MGZkNjk=
    ...
    def record_request(
        ...
        if should_filter_route(route_path):
            return
# pylint: disable  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2ZDJ4cVpnPT06MDg2MGZkNjk=
        ...
        for i, bucket_value in enumerate(self._histogram_buckets):
            if latency_seconds <= bucket_value:
                ...
                break
# type: ignore  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2ZDJ4cVpnPT06MDg2MGZkNjk=
...
# pragma: no cover  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2ZDJ4cVpnPT06MDg2MGZkNjk=
