...
# noqa  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2UWxCeVFnPT06YWEwMWE3OGE=
...
# type: ignore  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2UWxCeVFnPT06YWEwMWE3OGE=
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        if self.debug_enabled:
            ...
            async def inner_receive() -> Message:
                ...
                return message
# type: ignore  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2UWxCeVFnPT06YWEwMWE3OGE=
...
def _headers_to_dict(headers: list[tuple[bytes, bytes]] | None) -> dict[str, str]:
    ...
    for k, v in headers:
        ...
        if should_include_header_in_logs(key):
            result[key] = v.decode()
# pylint: disable  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2UWxCeVFnPT06YWEwMWE3OGE=
