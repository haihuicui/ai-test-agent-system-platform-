...
# noqa  MC8zOmFIVnBZMlhsdEpUbXRiZm92b2s2ZG1kTU1BPT06OTAxYzY2NDI=

from starlette.middleware.base import BaseHTTPMiddleware
from starlette.requests import Request
from starlette.responses import Response
from starlette.types import ASGIApp
# noqa  MS8zOmFIVnBZMlhsdEpUbXRiZm92b2s2ZG1kTU1BPT06OTAxYzY2NDI=
...
class PrivateNetworkMiddleware(BaseHTTPMiddleware):
    ...
    * https://developer.chrome.com/blog/private-network-access-update-2024-03
    ...
    def __init__(self, app: ASGIApp):
        ...
        super().__init__(app)
# pylint: disable  Mi8zOmFIVnBZMlhsdEpUbXRiZm92b2s2ZG1kTU1BPT06OTAxYzY2NDI=
