...
# pylint: disable  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2YjFGUlVBPT06ZmIyYzlmMWY=
...
# type: ignore  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2YjFGUlVBPT06ZmIyYzlmMWY=
...
class ApiRequest(Request):
    async def body(self) -> bytearray:
        if not hasattr(self, "_body"):
            ...
            self._body = chunks
        return self._body
# pylint: disable  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2YjFGUlVBPT06ZmIyYzlmMWY=
...
# pylint: disable  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2YjFGUlVBPT06ZmIyYzlmMWY=
