...
# pylint: disable  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2WmxkWlZ3PT06YTJmOTg4NzQ=

CUSTOM_STORE: BaseStore | Callable[[], BaseStore] | None = None
STORE_STACK = threading.local()
# pragma: no cover  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2WmxkWlZ3PT06YTJmOTg4NzQ=
...
# type: ignore  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2WmxkWlZ3PT06YTJmOTg4NzQ=
...
def _load_store(store_path: str) -> Any:
    ...
    return store
# pylint: disable  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2WmxkWlZ3PT06YTJmOTg4NzQ=
