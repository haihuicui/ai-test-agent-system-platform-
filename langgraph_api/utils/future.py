...
# fmt: off  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2ZERGb1pRPT06NjhlNTdlMGU=
...
# pragma: no cover  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2ZERGb1pRPT06NjhlNTdlMGU=
...
def chain_future(source: AnyFuture, destination: AnyFuture) -> AnyFuture:
    ...
    try:
        ...
        if isinstance(destination, concurrent.futures.Future):
            ...
            destination.set_exception(exc)
        raise
# fmt: off  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2ZERGb1pRPT06NjhlNTdlMGU=
...
# noqa  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2ZERGb1pRPT06NjhlNTdlMGU=
