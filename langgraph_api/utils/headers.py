...
# type: ignore  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2WTJONlRnPT06MDczYTc3MDM=
...
def get_configurable_headers(headers: Mapping[str, str]) -> dict[str, str]:
    ...
    for key, value in headers.items():
        ...
        if key.startswith("x-"):
            ...
            if should_include_header(key):
                configurable[key] = value
# pylint: disable  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2WTJONlRnPT06MDczYTc3MDM=
...
def should_include_header(key: str) -> bool:
    ...
    if (
        ...
        return False
# pragma: no cover  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2WTJONlRnPT06MDczYTc3MDM=
...
# noqa  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2WTJONlRnPT06MDczYTc3MDM=
