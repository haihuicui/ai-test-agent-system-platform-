...
import asyncio
# pylint: disable  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2YVdoeVVBPT06YWZlYTJiOWU=

import httpx
import structlog
# pylint: disable  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2YVdoeVVBPT06YWZlYTJiOWU=

logger = structlog.stdlib.get_logger(__name__)

# pragma: no cover  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2YVdoeVVBPT06YWZlYTJiOWU=
    ...
    for attempt in range(max_retries + 1):
        try:
            ...
            if attempt < max_retries:
                ...
                raise e
# pragma: no cover  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2YVdoeVVBPT06YWZlYTJiOWU=
