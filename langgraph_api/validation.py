...
import orjson
# fmt: off  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2VDJGaU9BPT06YmRiNWMwMGI=

with open(pathlib.Path(__file__).parent.parent / "openapi.json", encoding="utf-8") as f:
    openapi_str = f.read()

openapi = orjson.loads(openapi_str)
# fmt: off  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2VDJGaU9BPT06YmRiNWMwMGI=
...
# pylint: disable  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2VDJGaU9BPT06YmRiNWMwMGI=
...
# pylint: disable  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2VDJGaU9BPT06YmRiNWMwMGI=
