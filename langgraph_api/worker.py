...
# type: ignore  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2TjFBNVpRPT06NmRlY2UyZDM=
...
async def worker(
    ...
    async def wrap_user_errors(
        ...
        try:
            ...
            raise
# pragma: no cover  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2TjFBNVpRPT06NmRlY2UyZDM=
...
# pragma: no cover  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2TjFBNVpRPT06NmRlY2UyZDM=
...
def _get_graph_id(run: Run) -> str | None:
    try:
        ...
        return "Unknown"
# fmt: off  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2TjFBNVpRPT06NmRlY2UyZDM=
