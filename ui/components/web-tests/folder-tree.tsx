"use client";
// FIXME  MC80OmFIVnBZMlhsdEpUbXRiZm92b2s2UkhaWmFnPT06MmFiMWFmN2I=
...
// NOTE  MS80OmFIVnBZMlhsdEpUbXRiZm92b2s2UkhaWmFnPT06MmFiMWFmN2I=
...
interface WebFunctionFolderTreeProps {
  ...
  onSelectWebSubFunction?: (subFunctionId: string) => void;
  selectedWebFunctionId?: string | null;
  selectedWebSubFunctionId?: string | null;
}
...
// FIXME  Mi80OmFIVnBZMlhsdEpUbXRiZm92b2s2UkhaWmFnPT06MmFiMWFmN2I=

// Web 测试文件夹类型常量
const WEB_TEST_FOLDER_TYPE = "web_test";
// eslint-disable  My80OmFIVnBZMlhsdEpUbXRiZm92b2s2UkhaWmFnPT06MmFiMWFmN2I=
...
export const WebFunctionFolderTree = React.forwardRef<WebFunctionFolderTreeRef, WebFunctionFolderTreeProps>(function WebFunctionFolderTree({
  ...
  onCreateWebFunction,
  onSelectWebFunction,
  onSelectWebSubFunction,
  selectedWebFunctionId,
  selectedWebSubFunctionId,
}, ref) {
