...
export const translations = {
  ...
  environments: {
    title: "环境管理",
    description: "管理项目的 API 测试环境，包括 Base URL、认证信息等",
    create: "添加环境",
    createTitle: "添加环境",
    createDescription: "为项目添加一个新的 API 测试环境",
    editTitle: "编辑环境",
    editDescription: "修改环境配置信息",
    deleteTitle: "删除环境",
    deleteConfirm: '确定要删除环境 "{name}" 吗？此操作不可撤销。',
    name: "环境名称",
    namePlaceholder: "例如：开发环境、测试环境、生产环境",
    baseUrl: "Base URL",
    authType: "认证方式",
    bearerToken: "Bearer Token",
    bearerTokenPlaceholder: "输入 Bearer Token",
    apiKey: "API Key",
    apiKeyPlaceholder: "输入 API Key",
    apiKeyHeader: "API Key 请求头字段名",
    oauth2Token: "OAuth2 Token",
    oauth2TokenPlaceholder: "输入 OAuth2 Access Token",
    oauth2Config: "OAuth2 配置",
    oauth2ConfigPlaceholder: "client_id: xxx\ntoken_url: https://...\nscope: read",
    dynamicBearer: "动态 Bearer Token",
    tokenUrl: "Token 接口 URL",
    tokenUrlPlaceholder: "https://auth.example.com/api/login",
    tokenMethod: "请求方法",
    tokenPath: "Token 提取路径",
    tokenPathPlaceholder: "$.data.token",
    tokenTtl: "缓存 TTL（秒）",
    tokenHeaders: "Token 接口请求头",
    tokenHeadersPlaceholder: '{"Content-Type":"application/json"}',
    tokenBody: "Token 接口请求体",
    tokenBodyPlaceholder: '{"username":"admin","password":"secret"}',
    testConnection: "连通性测试",
    testConnectionHint: "验证 token 接口是否能正常返回",
    testFetch: "测试获取",
    dynamicBearerUrlRequired: "动态 Bearer 认证需要配置 Token 接口 URL",
    timeout: "默认超时（毫秒）",
    setAsDefault: "设为默认环境",
    setAsDefaultHint: "执行测试时，默认使用此环境",
    default: "默认",
    noData: "暂无环境配置",
    loadFailed: "加载环境配置失败",
    saveFailed: "保存环境配置失败",
    createSuccess: "环境配置创建成功",
    updateSuccess: "环境配置更新成功",
    deleteSuccess: "环境配置删除成功",
    deleteFailed: "删除环境配置失败",
    nameAndUrlRequired: "环境名称和 Base URL 不能为空",
    invalidTimeout: "超时时间必须大于等于 1000 毫秒",
    leaveBlankToKeep: "留空表示保持原有凭据不变",
    tokenConfigured: "已配置",
  ...
  apiTests: {
    ...
    noResults: "暂无执行结果",
    noTraceData: "未捕获到请求/响应明细（可能是旧数据或脚本未使用 trace helper）",
    selectEndpoint: "请选择一个接口",
    selectEndpointToViewResults: "从左侧列表或上方接口列表选择接口后查看执行结果",
    selectRun: "选择执行记录",
    selectRunToViewDetails: "从左侧列表选择一个执行记录查看详细结果",
    loadRunsFailed: "加载执行记录失败",
    loadResultsFailed: "加载执行结果失败",
...
// eslint-disable  MC8zOmFIVnBZMlhsdEpUbXRiZm92b2s2TXpkUWF3PT06MGM4NjQwMTk=

export default translations;
// NOTE  MS8zOmFIVnBZMlhsdEpUbXRiZm92b2s2TXpkUWF3PT06MGM4NjQwMTk=

// NOTE  Mi8zOmFIVnBZMlhsdEpUbXRiZm92b2s2TXpkUWF3PT06MGM4NjQwMTk=
